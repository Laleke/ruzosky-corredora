...
import { ESTADOS_INCIDENCIA } from "./constants";

type Opcion = { id: string; label: string };
type Campos = { propiedad: string; estado: string };
const VACIOS: Campos = { propiedad: "", estado: "" };

export function FiltroIncidencias({
  valores,
  propiedades,
  hayFiltros,
}: {
