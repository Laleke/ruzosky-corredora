...
**Pendiente / próximo (Centro Documental — 2026-07-03):**
0. **Aplicar `supabase/migrations/0015_documentos.sql`** en el SQL Editor de Supabase (crea tablas, enum, bucket `documentos` y políticas RLS de Storage). Sin esto, el módulo Documentos falla en runtime. Validar end-to-end: subir → ver → descargar → nueva versión → eliminar.
