...
**Última sesión: 2026-07-07.** App **en producción** (Vercel), redeploy con cada push. Repo `github.com/Laleke/ruzosky-corredora`. Login real: `admin@ruzosky.cl`. Rama `main` empujada hasta `8e314c7`; **esta sesión (`6c4c0b8`…`4ca4409`) es local, sin push.**
...
5. **Dashboard Operativo — evolución**: definir regla de negocio de "documento obligatorio por tipo de propiedad" para habilitar el indicador de documentos sin respaldo (hoy placeholder "Próximamente").
6. Menores: reinstalar PWA para tomar ícono/nombre; renombrar `empresas.nombre`.
